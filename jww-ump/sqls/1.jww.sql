...
CREATE TABLE IF NOT EXISTS `sys_menu` (
  ...
  `menu_type` smallint(2) DEFAULT '2' COMMENT '菜单类型(0:目录;1:菜单;2:按钮;)',
...
INSERT INTO `sys_menu` (`id_`,`menu_name`,`menu_type`,`parent_id`,`iconcls_`,`request_`,`expand_`,`sort_no`,`is_show`,`permission_`,`remark_`,`enable_`,`create_by`,`create_time`,`update_by`,`update_time`) VALUES (1,'系统管理',0,0,'icon-xitongguanli','#',1,1,1,'sys',NULL,1,1,'2016-06-20 09:16:56',1,'2016-06-29 08:19:19');
INSERT INTO `sys_menu` (`id_`,`menu_name`,`menu_type`,`parent_id`,`iconcls_`,`request_`,`expand_`,`sort_no`,`is_show`,`permission_`,`remark_`,`enable_`,`create_by`,`create_time`,`update_by`,`update_time`) VALUES (2,'用户管理',1,1,'icon-yonghuguanli','page/user/listUsers.html',0,1,1,'sys.base.user',NULL,1,1,'2016-06-20 09:16:56',1,'2016-06-29 08:38:35');
...
INSERT INTO `sys_menu` (`id_`,`menu_name`,`menu_type`,`parent_id`,`iconcls_`,`request_`,`expand_`,`sort_no`,`is_show`,`permission_`,`remark_`,`enable_`,`create_by`,`create_time`,`update_by`,`update_time`) VALUES (4,'菜单管理',1,1,'icon-caidanguanli','page/menu/menuList.html',0,3,1,'sys.base.menu',NULL,1,1,'2016-06-20 09:16:56',1,'2016-06-28 18:07:45');
...
INSERT INTO `sys_menu` (`id_`,`menu_name`,`menu_type`,`parent_id`,`iconcls_`,`request_`,`expand_`,`sort_no`,`is_show`,`permission_`,`remark_`,`enable_`,`create_by`,`create_time`,`update_by`,`update_time`) VALUES (9,'调度中心',0,0,'icon-xitongcanshuguanli','#',0,2,1,'sys.task',NULL,1,1,'2016-06-20 09:16:56',1,'2016-06-30 14:23:57');
...
INSERT INTO `sys_role_menu` (`id_`,`role_id`,`menu_id`,`permission_`,`enable_`,`remark_`,`create_by`,`create_time`,`update_by`,`update_time`) VALUES (41,1,22,'update',1,NULL,1,'2016-06-28 18:18:50',1,'2016-06-29 08:43:35');
...
INSERT INTO `sys_user` (`id_`, `account_`, `password_`, `user_type`, `user_name`, `name_pinyin`, `sex_`, `avatar_`, `phone_`, `email_`, `id_card`, `wei_xin`, `wei_bo`, `qq_`, `birth_day`, `dept_id`, `position_`, `address_`, `staff_no`, `enable_`, `remark_`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	(1, 'admin', 'YzlhZGMyNGYwNTk3NjA1NWQ4ZjdlZWI2NzlkNzIxZDk=', '3', '管理员', 'GUANLIYUAN', 0, 'http://118.190.43.148/group1/M00/00/00/dr4rlFjNBguAfJl7AAcOE67NTFk744.png', '15333821711', '12@12', NULL, NULL, NULL, NULL, '2017-01-27', 2, '213', NULL, NULL, 1, '1', '2016-05-06 10:06:52', 1, '2017-03-18 18:03:55', 1),
	(2, 'test', 'YzlhZGMyNGYwNTk3NjA1NWQ4ZjdlZWI2NzlkNzIxZDk=', '1', 'admin', 'CESHIRENYUAN', 1, 'http://118.190.43.148/group1/M00/00/00/dr4rlFj3H0iATcqFAAv7S9z_iMg689.png', '12345678901', '123@163.com', NULL, NULL, NULL, NULL, '2017-02-01', 825363166504628224, '测试', '', NULL, 1, '1', '2016-05-13 16:58:17', 1, '2017-05-29 08:31:38', 1);
