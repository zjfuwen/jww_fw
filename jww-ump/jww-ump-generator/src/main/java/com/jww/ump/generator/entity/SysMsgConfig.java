...
public class SysMsgConfig extends BaseModel {
	...
	public String toString() {
		return "SysMsgConfig{" +
			", smsPlatUrl=" + smsPlatUrl +
			", smsPlatAccount=" + smsPlatAccount +
			", smsPlatPassword=" + smsPlatPassword +
			", sendPhone=" + sendPhone +
			", senderName=" + senderName +
			", orderIsSend=" + orderIsSend +
			", payIsSend=" + payIsSend +
			", sendGoodsIsSend=" + sendGoodsIsSend +
			", registIsSend=" + registIsSend +
			", adviceGoodsIsSend=" + adviceGoodsIsSend +
			"}";
	}
}
